...
/**
 * @phq
 * Date 2020/11.27 11.28 ——初步完成了测试 但排序算法测试失败
 * Date 2020/12.1 —— 用了STL自带的swap函数 封装的排序算法中 冒泡和选择是自己写的，代码简单但运行稍慢
*/
...
void increase(Vector<T>& V) {
    Increase<T>inc;
    V.traverse(inc);//已Increase<T>()为函数对象进行遍历
}
template <typename T>
